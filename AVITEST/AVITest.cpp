...
{ 0xbc12ff80, 0xfbe4, 0x11ce, { 0xb7, 0x50, 0x44, 0x45, 0x53, 0x54, 0x0, 0x0 } };
...
BOOL CAVITestApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CAVITestDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CAVITestView));
